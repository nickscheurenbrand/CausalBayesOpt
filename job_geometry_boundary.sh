...
mkdir -p $HOME/causal_bayes_opt/results/boundary_tracking_erdos_geometry_new

# GEOMETRY_SCALE (appendix E) on Erdos50 + Erdos100, baseline only, 3 replicate
# seeds each -- 3 runs. Baseline means the parent set is inferred by the
...
LOG=$HOME/causal_bayes_opt/results/boundary_tracking_erdos_geometry_new/geometry_pbs.log
